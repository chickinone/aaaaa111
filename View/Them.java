...
public class Them extends JFrame {
    ...
    private JButton btnQuayLiTrang;
    ...
    public Them() {
        ...
        btnNewButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                // code xử lý khi nhấn nút "Thêm"
            }
        });
        btnNewButton.setFont(new Font("Times New Roman", Font.PLAIN, 14));
        btnNewButton.setBounds(425, 60, 133, 49);
        ...
        btnQuayLiTrang = new JButton("Quay lại trang chủ");
        btnQuayLiTrang.setFont(new Font("Times New Roman", Font.PLAIN, 14));
        btnQuayLiTrang.setBounds(425, 224, 166, 49);
